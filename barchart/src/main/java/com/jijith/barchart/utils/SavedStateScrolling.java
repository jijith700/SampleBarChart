package com.jijith.barchart.utils;
...
public class SavedStateScrolling implements Parcelable {
    private static final SavedStateScrolling EMPTY_STATE = new SavedStateScrolling() {
    };
     ...
     * @param in na
     */
    private SavedStateScrolling(Parcel in) {
